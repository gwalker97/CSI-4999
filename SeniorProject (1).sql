...
INSERT INTO `Addon` (`Addon_ID`, `Addon_House_ID`, `Addon_Room_ID`, `Addon_Host_ID`, `Addon_Name`, `Addon_Description`, `Addon_Pin`, `Addon_State`, `Addon_Type`, `Addon_Order`) VALUES
(1, 1, 2, 1, 'Light #1', 'Testing it out', 1, '0.00', 'L', 0),
(2, 1, 2, 1, 'Light #2', 'The hot lamp', 2, '0.00', 'L', 0),
(5, 1, 1, 1, 'Slider #1', 'By the chair', 4, '0.00', 'S', 0),
(7, 1, 2, 1, 'Fan #1', 'Above bed', 5, '0.00', 'F', 0);
...
INSERT INTO `Scenes` (`Scene_ID`, `House_ID`, `Scene_Name`, `Start_Time`, `End_Time`, `Is_Automated`, `Scene_Order`, `Scene_Color`) VALUES
(1, 1, 'Morning', NULL, NULL, 1, 1, 'red'),
(2, 1, 'Night', NULL, NULL, 1, 2, 'black'),
(3, 1, 'Study', NULL, NULL, 0, 3, 'blue');
...
INSERT INTO `Scene_Assignment` (`Scene_ID`, `Addon_ID`, `IsSet`) VALUES
(1, 7, 0),
(1, 2, 0),
(2, 7, 0),
(2, 5, 0),
