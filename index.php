                ...
                <div style="display: inline-block">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu new-dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item new-dropdown" data-toggle="modal" data-target="#newCompModal" onclick="fnClearApplianceModal()">Appliance</a>
                            <a class="dropdown-item new-dropdown" data-toggle="modal" data-target="#myModal" onclick="fnClearSceneModal()">Scene</a>
                            <a class="dropdown-item new-dropdown" data-toggle="modal" data-target="#controllerModal">Controller</a>
                        </div>
                    </div>
                </div>
