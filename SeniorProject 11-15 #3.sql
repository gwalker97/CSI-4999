...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2018 at 04:50 PM
...
CREATE TABLE `Room` (
  ...
  `House_ID` int(5) NOT NULL,
  `Room_gID` int(11) NOT NULL DEFAULT '2',
...
INSERT INTO `Room` (`Room_ID`, `House_ID`, `Room_gID`, `Room_Name`) VALUES
(1, 1, 2, 'Living Room'),
(2, 1, 2, 'Bedroom');
...
CREATE TABLE `Temp` (
  ...
  `Target_Temp_Type` varchar(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `Temp` (`Temp_ID`, `House_ID`, `C`, `F`, `Is_Automated`, `Target_Temp`, `Target_Temp_Type`) VALUES
(1, 1, 10, 50, b'0', 0, NULL);
...
ALTER TABLE `Room`
  ...
  ADD CONSTRAINT `room_ibfk_2` FOREIGN KEY (`Room_gID`) REFERENCES `Groups` (`Groups_gID`);
